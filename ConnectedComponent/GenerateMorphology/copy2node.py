...
myfiles = search("/scratch/jmmoon/connectedcomponent_clean/" , ".raw")
...
# 	for f in myfiles:
# 		if idx < 500:
# 			os.system("rsync -az " + f + " " + target_name + ":/scratch/jmmoon/connectedcomponent_clean_copy/")
# 		idx+=1
...
if target_num2 > 0:
	...
	for f in myfiles:
		if idx < 500:
			os.system("rsync -az " + f + " " + target_name2 + ":/scratch/jmmoon/connectedcomponent_clean_copy/")
		idx+=1
