...
string InputPath = "/scratch/jmmoon/Cell/Ganglia/Block/XY/";

string SavePath1 = "/scratch/jmmoon/Cell/Ganglia/Block/rotateYZ/";
string SavePath2 = "/scratch/jmmoon/Cell/Ganglia/Block/rotateZX/";
...
void Rotate(string filename){
	...
	unsigned int *blockxy = new unsigned int[block_size];
	unsigned int *blockyz = new unsigned int[block_size];
	unsigned int *blockzx = new unsigned int[block_size];

	fread(blockxy, block_size * sizeof(unsigned int), 1, blck_rfp);
	...
	fwrite(blockzx, block_size * sizeof(unsigned int), 1, blck_wfp_zx);
	fwrite(blockyz, block_size * sizeof(unsigned int), 1, blck_wfp_yz);
