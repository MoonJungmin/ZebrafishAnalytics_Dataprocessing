...
root_path = "/scratch/jmmoon/Cell/"
subregion_list = []
block_size = 512 * 512 * 512 * 4
...
for subregion in subregion_list:
	filelistXY = search(root_path+subregion+"/Block/XY", ".block")
	filelistYZ = search(root_path+subregion+"/Block/YZ", ".block")
	filelistZX = search(root_path+subregion+"/Block/ZX", ".block")
